...
\begin{figure}[t]
  ...
  \caption{Fission ource relative deviation from the reference, zone by zone: every analytical-model realization (gray, $N=500$) and every true brute-force replica (blue, $N=150$), raw (black) and corrected (red) point estimates, with the reference case's own $\pm2\sigma_{\text{ref}}$ (pink band); test cases 1--6.}
  \label{fig:fig5}
\end{figure}
